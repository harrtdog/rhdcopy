...
const storyTexts = {
    1: "Hey thereee, adventurer! 🌍 Ready to embark on an exciting journey through the rich culture of the Philippines? Your goal is to earn points by completing challenges, and once you reach the target score, you'll unlock breathtaking cultural landmarks across the country! 🏛️🌅",
...
function createBalut() {
  ...
  if (!balut.active) {
      balut.x = canvas.width + 500;  // Position balut to the right side of the screen
      balut.y = groundY - 160;       // Ensure it's on the ground
